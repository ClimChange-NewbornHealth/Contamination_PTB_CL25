...
writexl::write_xlsx(results_cox, path =  paste0("Output/", "Models/", "Cox_models_contamination_summer", ".xlsx"))

results_cox <- rio::import(paste0("Output/", "Models/", "Cox_models_contamination_summer", ".xlsx"))
...
pA <- make_pair(plot_data, "Kriging", "PM2.5", tag10 = "A.", tagIQR = "B.", li=0, lr=2)
pB <- make_pair(plot_data, "IDW",     "PM2.5", tag10 = "C.", tagIQR = "D.", li=0, lr=2)
...
print(final_plot)
ggsave("Output/Models/HR_Cox_panel_O3.png",
  #plot     = last_plot(),
  res      = 300,
  width    = 25,
  height   = 20,
